# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-07-31 14:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='gym',
            options={'ordering': ['name'], 'permissions': (('gym_trainer', 'Trainer: can see the users for a gym'),
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(default=True, help_text='Receive email overviews of inactive members',
